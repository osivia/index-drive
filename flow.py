...
class Flow(object):
    ...
    def fetch_token(self, **kwargs):
        ...
        return self.oauth2session.fetch_token(
            self.client_config['token_uri'], **kwargs, verify=False)
    ...
    def refresh_token(self, refresh_token, **kwargs):
        ...
        auth = requests.auth.HTTPBasicAuth(self.client_config['client_id'], self.client_config['client_secret'])


        self.oauth2session.refresh_token(self.client_config['token_uri'], **kwargs, refresh_token=refresh_token, auth=auth, verify=False);
